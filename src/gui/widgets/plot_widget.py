...
# --- Importamos 'settings' desde el módulo config ---
...
class PlotWidget(QWidget):
    ...
    def plot_data(self, df_metrics: pd.DataFrame):
        ...
        if x_series is not None and y_series is not None:
            ...
            # --- Leemos los umbrales desde 'settings' ---
            high_thresh = settings.squat_params.high_thresh
            low_thresh = settings.squat_params.low_thresh
